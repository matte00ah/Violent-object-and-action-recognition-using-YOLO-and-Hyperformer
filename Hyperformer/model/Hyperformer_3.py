...
class Model(nn.Module):
    def __init__(self, num_class=60, num_point=20, num_person=2, graph=None, graph_args=dict(), in_channels=3,
        ...
        self.l10 = TCN_ViT_unit(2*24*num_of_heads, 24*num_of_heads, A, residual=True, num_of_heads=num_of_heads, pe=True, num_point=num_point, layer=10)
        # standard ce loss
        # MODIFIED
        # original: self.fc = nn.Linear(24*num_of_heads, 10)
        # ora *2 perchè concat con yolo
    ...
    def forward(self, x, y):
        ...
        x[0] = self.l9(x[0], self.joint_label, groups)
