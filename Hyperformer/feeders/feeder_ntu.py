...
class Feeder(Dataset):
    ...
    def load_data(self):
        ...
        N = len(self.data)
        T, _ = self.data[0][0].shape
        for i in self.data:
            i[0] = i[0].reshape(T, 2, 25, 3).transpose(3, 0, 2, 1)
    ...
    def __getitem__(self, index):
        ...
        #MODIFIED
        # data_yolo = np.load(self.data[index][1])['tensor']
        data_yolo = self.data[index][1]
        ...
        return [data_numpy, data_yolo], label, index
